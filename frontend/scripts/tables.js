...
const playerHistoryBtn = document.getElementById("playerHistoryBtn");
const playerHistoryPopup = document.getElementById("playerHistoryPopup");
const closePlayerHistoryBtn = document.getElementById("closePlayerHistoryBtn");
...
// OPEN POPUP
playerHistoryBtn?.addEventListener("click",()=>{

    playerHistoryPopup.classList.remove("hidden");

    playerHistoryBody.innerHTML = "";

});


// CLOSE POPUP
closePlayerHistoryBtn?.addEventListener("click",()=>{

    playerHistoryPopup.classList.add("hidden");
...
let playerName = playerSearchInput.value.trim();
...
p1.toLowerCase().includes(playerName.toLowerCase())

||

p2.toLowerCase().includes(playerName.toLowerCase())
...
playerHistoryBody.innerHTML=html;
